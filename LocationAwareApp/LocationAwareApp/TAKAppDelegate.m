...
- (void)applicationWillResignActive:(UIApplication *)application
{
    ...
    if (self.locationController.locationManager) {
        [self.locationController.locationManager stopUpdatingLocation];
        self.locationController.isLocationManagerCurrentlyActive = NO;
    }
}
...
- (void)applicationWillEnterForeground:(UIApplication *)application
{
    ...
    if (self.locationController.locationManager) {
        ...
        self.locationController.isLocationManagerCurrentlyActive = YES;
    } else {
